...
public class Renderer extends GLCanvas implements GLEventListener, KeyListener, MouseMotionListener, MouseListener {
	...
	private float forward_Backward = -15.0f; //os z
	private float upward_Downward = 0.0f; //os y
	...
	private void keyMoving() {
		...
		if (pressedKeys[KeyEvent.VK_W]){
			...
			left_Right -= x;
			upward_Downward += y;
//			System.out.println("Forward: "+ forward_Backward+ " Left: "+ left_Right+" Stosunek: "+Math.sqrt(Math.pow(forward_Backward, 2)+Math.pow(left_Right, 2)));
//			System.out.println("Forward: "+ forward_Backward+ " MouseX: "+mouseX);
